...
class DistSQLVariableTest {
    ...
    void assertGetValueOfExistingVariable() {
        assertThat(DistSQLVariable.getValueOf("cached_connections"), is(DistSQLVariable.CACHED_CONNECTIONS));
    }
    
    @Test
    void assertGetValueOfUnsupportedVariable() {
        assertThrows(UnsupportedVariableException.class, () -> DistSQLVariable.getValueOf("unsupported"));
    }
}
