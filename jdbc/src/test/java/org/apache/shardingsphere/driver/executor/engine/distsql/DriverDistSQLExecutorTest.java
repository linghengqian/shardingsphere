...
class DriverDistSQLExecutorTest {
    ...
    private boolean invokeIsQueryStatement(final Object statement) throws Exception {
        java.lang.reflect.Method method = DriverDistSQLExecutor.class.getDeclaredMethod("isQueryStatement",
                org.apache.shardingsphere.distsql.statement.DistSQLStatement.class);
